<template>
  ...
  >
    <div
      v-if="post && user"
      class="justify-center q-py-lg col-10"
    >
      <div class="col-12">
        <div class="row">
          <div class="post-header col-9">{{post.title}}</div>
          <div class="col-3 flex items-center justify-end btns">
            <div v-if="isSelf">
              <q-btn
                :label="$t('EDIT')"
                color="primary"
        ...
        <div class="row author-container">
          ...
          <p class="author-info">
            ...
            <q-btn
              ...
              color="green"
              :loading="optLoad"
              :icon="isSub?'remove_circle_outline':'add'"
              @click="toggleSub"
              dense
              outline
              size="xs"
      ...
      <vue-markdown class="q-my-lg">{{post.content}}</vue-markdown>
      <dir class="row justify-center q-my-sm">
        <q-btn
